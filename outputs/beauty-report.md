...
1. A005132 - Recaman sequence
   BeautyIndex=0.493 | CoagulationScore=0.327 | CoagulationMode=tile | StructuralBeauty=0.775 | CompositionPower=0.503 | CompositionGuideMean=0.493 | CompositionAvoidPenalty=0.455 | Compressibility=0.879 | DeltaSignEntropy=0.999 | GrowthDrama=0.615 | ResidueStructure=0.003 | Novelty=0.854
...
2. A000002 - Kolakoski sequence
   BeautyIndex=0.435 | CoagulationScore=0.287 | CoagulationMode=tile | StructuralBeauty=0.663 | CompositionPower=0.482 | CompositionGuideMean=0.480 | CompositionAvoidPenalty=0.512 | Compressibility=0.975 | DeltaSignEntropy=1.000 | GrowthDrama=0.282 | ResidueStructure=0.000 | Novelty=0.008
...
3. A000040 - Prime numbers
   BeautyIndex=0.383 | CoagulationScore=0.318 | CoagulationMode=tile | StructuralBeauty=0.432 | CompositionPower=0.490 | CompositionGuideMean=0.506 | CompositionAvoidPenalty=0.577 | Compressibility=0.890 | DeltaSignEntropy=0.000 | GrowthDrama=0.053 | ResidueStructure=0.203 | Novelty=1.000
...
4. A000041 - Partition numbers
   BeautyIndex=0.347 | CoagulationScore=0.304 | CoagulationMode=tile | StructuralBeauty=0.336 | CompositionPower=0.492 | CompositionGuideMean=0.517 | CompositionAvoidPenalty=0.611 | Compressibility=0.626 | DeltaSignEntropy=0.039 | GrowthDrama=0.062 | ResidueStructure=0.014 | Novelty=0.996
...
5. A000045 - Fibonacci numbers
   BeautyIndex=0.332 | CoagulationScore=0.293 | CoagulationMode=tile | StructuralBeauty=0.321 | CompositionPower=0.463 | CompositionGuideMean=0.482 | CompositionAvoidPenalty=0.614 | Compressibility=0.579 | DeltaSignEntropy=0.039 | GrowthDrama=0.037 | ResidueStructure=0.075 | Novelty=0.996
