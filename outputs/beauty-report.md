...
Generated: 2026-02-17 12:30

## Ranking by BeautyIndex

1. A005132 - Recaman sequence
   BeautyIndex=0.452 | CoagulationScore=0.327 | CoagulationMode=tile | StructuralBeauty=0.775 | Compressibility=0.879 | DeltaSignEntropy=0.999 | GrowthDrama=0.615 | ResidueStructure=0.003 | Novelty=0.854
...
2. A000002 - Kolakoski sequence
   BeautyIndex=0.392 | CoagulationScore=0.287 | CoagulationMode=tile | StructuralBeauty=0.663 | Compressibility=0.975 | DeltaSignEntropy=1.000 | GrowthDrama=0.282 | ResidueStructure=0.000 | Novelty=0.008
...
3. A000040 - Prime numbers
   BeautyIndex=0.350 | CoagulationScore=0.318 | CoagulationMode=tile | StructuralBeauty=0.432 | Compressibility=0.890 | DeltaSignEntropy=0.000 | GrowthDrama=0.053 | ResidueStructure=0.203 | Novelty=1.000
...
4. A000041 - Partition numbers
   BeautyIndex=0.312 | CoagulationScore=0.303 | CoagulationMode=tile | StructuralBeauty=0.336 | Compressibility=0.626 | DeltaSignEntropy=0.039 | GrowthDrama=0.062 | ResidueStructure=0.014 | Novelty=0.996
   OEIS: https://oeis.org/A000041
   History: The Hardy-Ramanujan circle method famously explains partition growth.
   Atlas: coagulation-tile (score=0.676)
...
5. A000045 - Fibonacci numbers
   BeautyIndex=0.301 | CoagulationScore=0.293 | CoagulationMode=tile | StructuralBeauty=0.321 | Compressibility=0.579 | DeltaSignEntropy=0.039 | GrowthDrama=0.037 | ResidueStructure=0.075 | Novelty=0.996
